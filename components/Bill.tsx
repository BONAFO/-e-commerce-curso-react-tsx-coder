...
import { useBillHook } from "@/hooks/pay/Bill";

export function BillCart(): React.ReactElement {
                  ...
                  >
                    ...
                    <Box sx={{ display: "flex", gap: 1, mt: 1 }}>
                      <Button
                        ...
                        onClick={() => handleRemoveOne(item.id as string)}
                      >
                        -1
                      </Button>
                      <Button
                        ...
                        size="small"
                        sx={{ minWidth: "40px", padding: "2px 6px" }}
                        onClick={() => handleRemoveStack(item.id as string)}
                      >
                        X
                      </Button>
                    </Box>
